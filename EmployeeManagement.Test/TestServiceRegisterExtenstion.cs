...
{
    public class TestServiceRegisterExtenstion
    {
        [Fact]
        public void RegisterDataServices_Excute_DataServiceAreRegistured()
        {
            // Arrange
        ...
        [Fact]
        public void RegisterDataServices_Excute_EmployeeManagementRepositoryMustBeTheImplementation()
        {
            // Arrange
            var serviceCollection = new ServiceCollection();
            var configuration = new ConfigurationBuilder()
